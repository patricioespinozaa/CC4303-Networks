...
# localhost
generar_archivo_binario("files_localhost/big_file.bin", 1000000)
...
# localhost
for i in range(100):
    generar_archivo_binario(f"files_localhost/file_{i}.bin", 10000)

# anakena
for i in range(100):
    generar_archivo_binario(f"files_anakena/file_{i}.bin", 5)
